      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 md:gap-16 mb-16 md:mb-24">
          <div className="lg:col-span-4">
            ...
            <p className="text-zinc-500 leading-relaxed mb-10 font-light text-sm max-w-sm">
              The benchmark for premium pre-owned luxury. Direct wholesale access, uncompromised quality, and
              transparent BC-wide service since 2018.
            </p>
            <div className="flex gap-5">
              <a
                href="#"
                className="w-12 h-12 rounded-2xl bg-zinc-900 flex items-center justify-center hover:bg-[#D4AF37] hover:text-black transition-all group"
              >
          ...
          <div className="lg:col-span-3">
            ...
            <p className="text-zinc-500 text-xs leading-relaxed mb-6 font-light">
              Join our elite list for wholesale inventory drops before they hit the public market.
            </p>
            {subscribed ? (
              ...
              <form onSubmit={handleSubscribe} className="relative group">
                ...
                <button
                  type="submit"
                  className="absolute right-3 top-3 w-10 h-10 bg-white text-black rounded-xl flex items-center justify-center hover:bg-[#D4AF37] transition-all group-focus-within:bg-[#D4AF37]"
                >
                  <Send size={16} />
                </button>
              </form>
        ...
        <div className="border-t border-white/5 pt-8 md:pt-12 flex flex-col md:flex-row justify-between items-center gap-6 md:gap-8 text-center md:text-left">
          ...
          <div className="flex flex-wrap items-center justify-center md:justify-end gap-4 sm:gap-6">
            <Link to="/admin" className="text-zinc-600 text-[9px] font-black uppercase tracking-widest hover:text-white transition-colors">
              Admin Access
            </Link>
            <Link to="/privacy" className="text-zinc-600 text-[9px] font-black uppercase tracking-widest hover:text-white transition-colors">
              Privacy Hub
            </Link>
