  ...
  const navItems = [
    ...
    { 
      ...
      sub: [
        ...
        { name: 'Directions', path: DIRECTIONS_URL, external: true }
      ]
    }
  ];
          ...
          <div className="hidden lg:flex items-center gap-10">
            {navItems.map((item) => (
              <div key={item.name} className="relative group">
                ...
                {item.sub && (
                  <div className="absolute top-full left-1/2 -translate-x-1/2 mt-0 pt-4 hidden group-hover:block w-64 z-[1200] pointer-events-auto animate-in fade-in slide-in-from-top-2 duration-300">
